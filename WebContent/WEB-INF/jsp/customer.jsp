...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="<%=basePath%>customer/list.action">电影后台管理系统</a>
	</div>
	<!-- 导航栏右侧图标部分 -->
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li>
				    <a href="#">
				      <i class="fa fa-dashboard fa-fw" ></i> 电影管理
				    </a>
				</li>
			</ul>
		</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get" 
					...
					<div class="form-group">
						<label for="custLevel">用户级别</label>
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_customer_form">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="new_customerName" placeholder="用户名称" name="cust_name" />
						</div>
					</div>
					<div class="form-group">
						<label for="new_customerFrom" style="float:left;padding:7px 15px 0 27px;">用户来源</label> 
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="new_custLevel" style="float:left;padding:7px 15px 0 27px;">用户级别</label>
						<div class="col-sm-10">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="edit_customer_form">
					...
					<div class="form-group">
						<label for="edit_customerFrom" style="float:left;padding:7px 15px 0 27px;">用户来源</label> 
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label for="edit_custLevel" style="float:left;padding:7px 15px 0 27px;">用户级别</label>
						<div class="col-sm-10">
